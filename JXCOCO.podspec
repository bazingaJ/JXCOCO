...
创建一个库，自己测试一下
  ...
  # Or just: spec.author    = "Jesse Enzo"
  # spec.authors            = { "Jesse Enzo" => "yjingxu007@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Jesse Enzo"
  ...
  spec.source_files  = "JXButton", "JXButton/*.{h,m}"
  spec.exclude_files = "JXButton/Exclude"
