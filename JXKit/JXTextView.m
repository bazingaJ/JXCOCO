...
CGFloat const kJXTextViewPlaceholderVerticalMargin = 8.0; ///< placeholder垂直方向边距
CGFloat const kJXTextViewPlaceholderHorizontalMargin = 6.0; ///< placeholder水平方向边距

@interface JXTextView ()

@property (nonatomic, copy) JXTextViewHandler changeHandler; ///< 文本改变Block
@property (nonatomic, copy) JXTextViewHandler maxHandler; ///< 达到最大限制字符数Block
...
- (void)initialize
{
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeTop
                                                    multiplier:1.0
                                                      constant:kJXTextViewPlaceholderVerticalMargin]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeLeft
                                                    multiplier:1.0
                                                      constant:kJXTextViewPlaceholderHorizontalMargin]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeWidth
                                                    multiplier:1.0
                                                      constant:-kJXTextViewPlaceholderHorizontalMargin*2]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeHeight
                                                    multiplier:1.0
                                                      constant:-kJXTextViewPlaceholderVerticalMargin*2]];
}
...
- (void)addTextDidChangeHandler:(JXTextViewHandler)changeHandler
{
    _changeHandler = [changeHandler copy];
}

- (void)addTextLengthDidMaxHandler:(JXTextViewHandler)maxHandler
{
